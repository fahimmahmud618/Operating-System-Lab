...
int size, num_threads=3,num_threads2=9;
...
{
	matrix3[1][2]=matrix1[1][0]*matrix2[0][1]+matrix1[1][1]*matrix2[1][1]+matrix1[1][2]*matrix2[2][1];
}

else if (tid == 6 )
{
	matrix3[2][0]=matrix1[2][0]*matrix2[0][0]+matrix1[2][1]*matrix2[1][0]+matrix1[2][2]*matrix2[2][0];
}

else if (tid == 7 )
{
	matrix3[2][1]=matrix1[2][0]*matrix2[0][1]+matrix1[2][1]*matrix2[1][1]+matrix1[2][2]*matrix2[2][1];
}

else if (tid == 8 )
{
	matrix3[2][2]=matrix1[2][0]*matrix2[0][2]+matrix1[2][1]*matrix2[1][2]+matrix1[2][2]*matrix2[2][2];
}
...
int main( int argc, char *argv[] )
{
  ...
  *tid = 2;
  ...
  for ( i = 0; i < num_threads2; ++i ) {
    *tid = i;
    pthread_create( &threads2[i], NULL, worker1, (void *)tid );
    sleep(1);
  }
